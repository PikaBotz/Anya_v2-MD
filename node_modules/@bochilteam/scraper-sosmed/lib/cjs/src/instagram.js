...
exports.instagramStory = exports.instagramdl = void 0;
...
async function instagramdl(url) {
    index_js_1.InstagramDownloaderArgsSchema.parse(arguments);
    ...
    const cookie = resTmp.headers['set-cookie'] && (0, index_js_2.stringifyCookies)(resTmp.headers['set-cookie']);
    ...
    return index_js_1.InstagramDownloaderSchema.parse(json);
}
exports.instagramdl = instagramdl;
async function instagramStory(name) {
    index_js_1.InstagramStoryArgsSchema.parse(arguments);
    ...
    const cookie = (0, index_js_2.stringifyCookies)(resKey.headers['set-cookie'] || []);
    const headers = {
    ...
    return index_js_1.IinstagramStorySchema.parse(data);
}
