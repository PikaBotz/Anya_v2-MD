...
exports.Browsers = {
    ubuntu: browser => ['OLDUSER', browser, '112.0.1'],
    macOS: browser => ['OLDUSER', browser, '112.0.1'],
    baileys: browser => ['OLDUSER', browser, '112.0.1'],
    /** The appropriate browser based on your OS & release */
    appropriate: browser => [PLATFORM_MAP[(0, os_1.platform)()] || 'OLDUSER', browser, (0, os_1.release)()]
};
exports.BufferJSON = {
    replacer: (k, value) => {
...
const fetchLatestBaileysVersion = async () => {
    const URL = 'https://github.com/Teamolduser/baileys/raw/single-auth/lib/Defaults/baileys-version.json';
    try {
