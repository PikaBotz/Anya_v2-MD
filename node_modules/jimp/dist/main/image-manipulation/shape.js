...
exports.mirror = exports.flip = void 0;

var _resize2 = _interopRequireDefault(require("../modules/resize"));

var _resize3 = _interopRequireDefault(require("../modules/resize2"));
...
function simpleRotate(deg) {
  ...
  while (i > 0) {
    ...
    for (var x = this.bitmap.width - 1; x >= 0; x--) {
...
function rotate(deg, mode, cb) {
  ...
  if (typeof deg !== 'number') {
    return _errorChecking.throwError.call(this, 'deg must be a number', cb);
  }

  if (typeof mode !== 'boolean' && typeof mode !== 'string') {
    return _errorChecking.throwError.call(this, 'mode must be a boolean or a string', cb);
  }
...
function flipFn(horizontal, vertical, cb) {
  if (typeof horizontal !== 'boolean' || typeof vertical !== 'boolean') return _errorChecking.throwError.call(this, 'horizontal and vertical must be Booleans', cb);
...
function resize(w, h, mode, cb) {
  ...
  if (w === constants.AUTO && h === constants.AUTO) {
    return _errorChecking.throwError.call(this, 'w and h cannot both be set to auto', cb);
  }
  ...
  if (w < 0 || h < 0) {
    return _errorChecking.throwError.call(this, 'w and h must be positive numbers', cb);
  } // round inputs
  ...
  if (typeof _resize3.default[mode] === 'function') {
    var dst = {
    ...
    _resize3.default[mode](this.bitmap, dst);

    this.bitmap = dst;
  } else {
    var image = this;

    var _resize = new _resize2.default(this.bitmap.width, this.bitmap.height, w, h, true, true, function (buffer) {
...
function cover(w, h, alignBits, mode, cb) {
  if (typeof w !== 'number' || typeof h !== 'number') {
    return _errorChecking.throwError.call(this, 'w and h must be numbers', cb);
  }
  ...
  alignBits = alignBits || this.HORIZONTAL_ALIGN_CENTER | this.VERTICAL_ALIGN_MIDDLE;
  var hbits = alignBits & (1 << 3) - 1;
  var vbits = alignBits >> 3; // check if more flags than one is in the bit sets

  if (!(hbits !== 0 && !(hbits & hbits - 1) || vbits !== 0 && !(vbits & vbits - 1))) return _errorChecking.throwError.call(this, 'only use one flag per alignment direction', cb);
...
function contain(w, h, alignBits, mode, cb) {
  if (typeof w !== 'number' || typeof h !== 'number') {
    return _errorChecking.throwError.call(this, 'w and h must be numbers', cb);
  ...
  if (!(hbits !== 0 && !(hbits & hbits - 1) || vbits !== 0 && !(vbits & vbits - 1))) {
    return _errorChecking.throwError.call(this, 'only use one flag per alignment direction', cb);
  }
...
function scale(f, mode, cb) {
  if (typeof f !== 'number') {
    return _errorChecking.throwError.call(this, 'f must be a number', cb);
  }

  if (f < 0) {
    return _errorChecking.throwError.call(this, 'f must be a positive number', cb);
  }
...
function scaleToFit(w, h, mode, cb) {
  if (typeof w !== 'number' || typeof h !== 'number') {
    return _errorChecking.throwError.call(this, 'w and h must be numbers', cb);
  }
...
function displace(map, offset, cb) {
  if (_typeof(map) !== 'object' || map.constructor !== this.constructor) {
    return _errorChecking.throwError.call(this, 'The source must be a Jimp image', cb);
  }

  if (typeof offset !== 'number') {
    return _errorChecking.throwError.call(this, 'factor must be a number', cb);
  }
