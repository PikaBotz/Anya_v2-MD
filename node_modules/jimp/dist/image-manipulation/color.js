...
exports.colour = exports.color = exports.opacity = exports.grayscale = void 0;
...
var _isDef = _interopRequireDefault(require("../utils/is-def"));
 ...
 */
function brightness(val, cb) {
  if (typeof val !== 'number') {
    return _errorChecking.throwError.call(this, 'val must be numbers', cb);
  }

  if (val < -1 || val > +1) {
    return _errorChecking.throwError.call(this, 'val must be a number between -1 and +1', cb);
  }
...
function posterize(n, cb) {
  if (typeof n !== 'number') {
    return _errorChecking.throwError.call(this, 'n must be numbers', cb);
  }
...
var opacity = function opacity(f, cb) {
  if (typeof f !== 'number') return _errorChecking.throwError.call(this, 'f must be a number', cb);
  if (f < 0 || f > 1) return _errorChecking.throwError.call(this, 'f must be a number from 0 to 1', cb);
  this.scanQuiet(0, 0, this.bitmap.width, this.bitmap.height, function (x, y, idx) {
...
function fade(f, cb) {
  if (typeof f !== 'number') {
    return _errorChecking.throwError.call(this, 'f must be a number', cb);
  }

  if (f < 0 || f > 1) {
    return _errorChecking.throwError.call(this, 'f must be a number from 0 to 1', cb);
...
function convolution(kernel, edgeHandling, cb) {
...
function pixelate(size, x, y, w, h, cb) {
  if (typeof x === 'function') {
    ...
    if (typeof size !== 'number') {
      return _errorChecking.throwError.call(this, 'size must be a number', cb);
    }

    if ((0, _isDef.default)(x) && typeof x !== 'number') {
      return _errorChecking.throwError.call(this, 'x must be a number', cb);
    }

    if ((0, _isDef.default)(y) && typeof y !== 'number') {
      return _errorChecking.throwError.call(this, 'y must be a number', cb);
    }

    if ((0, _isDef.default)(w) && typeof w !== 'number') {
      return _errorChecking.throwError.call(this, 'w must be a number', cb);
    }

    if ((0, _isDef.default)(h) && typeof h !== 'number') {
      return _errorChecking.throwError.call(this, 'h must be a number', cb);
    }
  }
  ...
  x = x || 0;
  y = y || 0;
  w = (0, _isDef.default)(w) ? x : this.bitmap.width - x;
  h = (0, _isDef.default)(h) ? h : this.bitmap.height - y;
...
function convolute(kernel, x, y, w, h, cb) {
  if (!Array.isArray(kernel)) return _errorChecking.throwError.call(this, 'the kernel must be an array', cb);
  ...
  x = (0, _isDef.default)(x) ? x : ksize;
  y = (0, _isDef.default)(y) ? y : ksize;
  w = (0, _isDef.default)(w) ? w : this.bitmap.width - x;
  h = (0, _isDef.default)(h) ? h : this.bitmap.height - y;
  var source = this.cloneQuiet();
  this.scanQuiet(x, y, w, h, function (xx, yx, idx) {
    var value = applyKernel(source, kernel, xx, yx);
...
function colorFn(actions, cb) {
  if (!actions || !Array.isArray(actions)) {
    return _errorChecking.throwError.call(this, 'actions must be an array', cb);
  }
  ...
  this.scanQuiet(0, 0, this.bitmap.width, this.bitmap.height, function (x, y, idx) {
    ...
    actions.forEach(function (action) {
      if (action.apply === 'mix') {
        ...
        if (!fn) {
          return _errorChecking.throwError.call(originalScope, 'action ' + action.apply + ' not supported', cb);
        }
