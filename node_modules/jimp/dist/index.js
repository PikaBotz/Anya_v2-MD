...
Jimp.loadFont = function (file, cb) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    (0, _loadBmfont.default)(file, function (err, font) {
      ...
      for (var _i4 = 0; _i4 < font.chars.length; _i4++) {
        chars[String.fromCharCode(font.chars[_i4].id)] = font.chars[_i4];
      }

      for (var _i5 = 0; _i5 < font.kernings.length; _i5++) {
        var firstString = String.fromCharCode(font.kernings[_i5].first);
        kernings[firstString] = kernings[firstString] || {};
        kernings[firstString][String.fromCharCode(font.kernings[_i5].second)] = font.kernings[_i5].amount;
      }
...
jimpEvChange('scan', function (x, y, w, h, f, cb) {
  ...
  var result = (0, _scan.default)(this, x, y, w, h, f);
