    ...
    case constants.MIME_JPEG:
      {
        ...
        var jpeg = JPEG.encode(compositeBitmapOverBackground(this.constructor, this), this._quality);
    ...
    case constants.MIME_X_MS_BMP:
      {
        // composite onto a new image so that the background shows through alpha channels
        toAGBR(this);
        var bmp = BMP.encode(compositeBitmapOverBackground(this.constructor, this));
