...
global.author = "Ken_kaneki"  
global.packname = "𝙌𝙐𝙀𝙀𝙉✯𝘼𝙉𝙔𝘼✯𝘽𝙊𝙏"  
global.myweb = "https://github.com/PikaBotz" // You can put any link 
global.waterMark = "×͜× King ✘ Ken_kaneki™ ✓" // Your own watermark 
global.headerText = "Anya by Pika" // text for header of menu         
global.DocumentTitle = "MASTER⚔️PIKA" 


global.ownername = "Ken_kaneki"   // Owner name //        
global.ownernumber = ['0640164197'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : 3.69_pika" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT: Ůhm modding pro"   // Yt chanel name //
global.continent = "Africa" // your continent name 
global.region = "South africa" // your country name
global.state = "Northwest" // your state name
global.district = "Bojanala" // your district name
global.timezone = "SAST/EAT" // search on google if you don't know the timezone of your country //
global.instagramId = "3.69_pika" // Your insta ID
global.email = "theboyyregow@gmail.com" // put your email here


//------------ 🌟 Premium Users 🌟-------------\\
global.premium = ['916900******','917355******']  // available soon
global.sudo = ['0640164197','917355******']  // Co - Owners //
