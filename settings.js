...
global.botname = "faheem v1" 
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || urdu || 𝗔𝗿𝗮𝗯𝗶𝗰 \\
global.author = "faheem"  
global.packname = "faheem khan"  
global.myweb = "https://github.com/Faheemxyz" // You can put any link 
global.waterMark = "×͜× King ✘ faheem ™ ✓" // Your own watermark 
global.headerText = "faheem by mod" // text for header of menu         
global.DocumentTitle = "MASTER⚔️faheem" 


global.ownername = "faheem"   // Owner name //        
global.ownernumber = ['923067193190'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : 3.69_faheem" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT: faheem mod"   // Yt chanel name //
global.continent = "Asia" // your continent name 
global.region = "Pakistan" // your country name
global.state = "faheemkhan" // your state name
global.district = "Dibrugarh" // your district name
global.timezone = "Pakistan/dajal" // search on google if you don't know the timezone of your country //
global.instagramId = "3.69_faheem" // Your insta ID
global.email = "mf1133192@gmail.com" // put your email here


//------------ 🌟 Premium Users 🌟-------------\\
global.premium = ['92306******','92336******']  // available soon
global.sudo = ['92306******','92336******']  // Co - Owners //

global.prefa = ['-','🥵','🔥']

//--------Random bot name for Info section--------\\
name16 = "𓄂⍣⃝ faheem 𓆩×͜×𓆪ꪾ️"
name17 = "*faheem 𓆩×͜×𓆪ꪾ*"
name18 = "*faheem 𓆩×͜×𓆪ꪾ*"

//--------Random footer message-----------\\
footer1 = `𓄂⍣⃝faheem 𝟤ㅤ𓆩×͜×𓆪ꪾ `
footer2 = `Λfaheemㅤꪜ⃢𝟤ㅤ𓆩×͜×𓆪ꪾ`
