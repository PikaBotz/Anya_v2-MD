...
global.botname = "DEVIL RAZA" 
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || 𝗔𝗿𝗮𝗯𝗶𝗰 \\
global.author = "RAZA"  
global.packname = "DEVIL✯RAZA✯𝘽𝙊𝙏"  
global.myweb = "https://github.com/RAZABotz" // You can put any link 
global.waterMark = "×͜× King ✘ RAZA™ ✓" // Your own watermark 
global.headerText = "HUSSAIN by RAZA" // text for header of menu         
global.DocumentTitle = "MASTER⚔️RAZA" 


global.ownername = "♘♘🄳🄴🅅🄸🄻 🅁🄰🅉🄰⌐╦╦═─"// Owner name //        
global.ownernumber = ['923238744389'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : 3.69_RAZA" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "YT: Ytname"   // Yt chanel name //
global.continent = "Asia" // your continent name 
global.region = "India" // your country name
global.state = "Assam" // your state name
global.district = "ATTOCK" // your district name
global.timezone = "Asia/punjab" // search on google if you don't know the timezone of your country //
global.instagramId = "3.69_RAZA" // Your insta ID
global.email = "example@exmaple.com" // put your email here


//------------ 🌟 Premium Users 🌟-------------\\
global.premium = ['923238744389','923238744389']  // available soon
global.sudo = ['923238744389','923238744389']  // Co - Owners //

global.prefa = ['-']

//--------Random bot name for Info section--------\\
name16 = "𓄂⍣⃝🇷AZA 𓆩×͜×𓆪ꪾ️"
name17 = "*Λ⃝ͷ🇾Λ 𓆩×͜×𓆪ꪾ*"
name18 = "*Λ⃝ͷʏΛ 𓆩×͜×𓆪ꪾ*"

//--------Random footer message-----------\\
footer1 = `𓄂⍣⃝🇷AZAㅤꪜ⃢𝟤ㅤ𓆩×͜×𓆪ꪾ `
