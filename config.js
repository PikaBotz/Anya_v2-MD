...
module.exports = {
     ...
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "shenu",
    ownernumber: process.env.Owner_Number || "94723205812",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://SithumKalhara:97531@cluster0.iva7dbo.mongodb.net/?retryWrites=true&w=majority",
    sessionId: process.env.SESSION_ID || "aAf1p26n_A_N_Y_A_V_2_J1Kp9gHnFivw",
