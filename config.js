...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "ナッシング.",
    ownernumber: process.env.Owner_Number || "237671722583",
    instagramId: process.env.Insta || "im_n0th1n9",
    ...
    sessionId: process.env.SESSION_ID || "0JaNn8j57KSQv66v_A_N_Y_A_V_2_jNRl",
