...
module.exports = {
    ...
    ownernumber: process.env.Owner_Number || "2348149825074",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://Exryden:Alpha102($$)@cluster0.jjnlg.mongodb.net/",
    sessionId: process.env.SESSION_ID || "djYyMnR_AN_YA_6eXA=",
