...
module.exports = {
    ...
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 > *TYG ×͜× GHOST❤‍🩹𓃵🪽*",
     ...
     */
    ownername: process.env.Owner_Name || "> *TYG ×͜× GHOST❤‍🩹𓃵🪽*",
    ownernumber: process.env.Owner_Number || "2347040463391",
    ...
    sessionId: process.env.SESSION_ID || "NzN1aGt_Queen-Anya_kcDE=",
