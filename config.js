...
module.exports = {
  botname: process.env.BotName || "Sahan", 
  author: process.env.Author || "Sahan",
  packname: process.env.PackName || "Queen Anya v2 MD",
  myweb: process.env.Web || "https://github.com/maduwa2006",
  footer: process.env.Footer || "© Queen Anya Bot",
  prefa: process.env.Prefix || ['.'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Sahan",
  ownernumber: process.env.Owner_Number || "94720797915",
  ...
  mongoUrl: process.env.MongoDB || "mongodb+srv://Sahan:Sahan123456@cluster0.2s8k9t2.mongodb.net/",
