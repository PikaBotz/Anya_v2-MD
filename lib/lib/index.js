...
module.exports = {
  anya,
  commands,
  greetTime: require(__dirname + '/greeting'),
  listall,
  tiny,
  fancy10,
  fancy11,
  ...
  delWarn,
  clearWarn,
  smsg: require(__dirname + '/functions'),
  getPrefix: require(__dirname + '/prefix'),
  getBuffer,
  pickRandom,
  formatDate,
  numberToDate,
  ...
  getObjArray,
  getRandom,
  similar: require(__dirname + '/similar'),
  cooldown: require(__dirname + '/cooldown'),
  pik4nya: require(__dirname + '/buttons'),
  aiArtGenerator,
  PinterestDownloader,
  playStoreSearch,
  SoundCloudeSearch,
  ...
  stickerToVideo,
  toAudio,
  fix: require(__dirname + '/mongoUrlFix'),
  api,
  connectionMsg: require(__dirname + '/connectionMsg'),
  groupEventListener,
  groupChangesListener,
  youtube: require(__dirname + '/ytdl-core'),
  reactions: require(__dirname + '/../frameworks/reactionMedia'),
  Quiz,
  Questions,
  ManageDB: require(__dirname + '/../database/disk/main'),
