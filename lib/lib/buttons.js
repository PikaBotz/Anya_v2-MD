             ...
             */
              ...
              */
              case '31': {
                ...
                else if (body.text === "0") cmd = `${prefix}declineeverygrouprequest ${mentions.join(" ")}`;
                else if (body.text === "00") cmd = `${prefix}accepteverygrouprequest ${mentions.join(" ")}`;
                else cmd = `${prefix}accepteverygrouprequest ${mentions[number - 1]}`;
              }
              break;
              ...
              */
              case '35': case '36': {
                ...
                if (/1/.test(number)) cmd = `${prefix + selector} Antilink`;
                else if (/2/.test(number)) cmd = `${prefix + selector} Antibot`;
                else if (/3/.test(number)) cmd = `${prefix + selector} Antitoxic`;
                else if (/4/.test(number)) cmd = `${prefix + selector} Antivirus`;
                else if (/5/.test(number)) cmd = `${prefix + selector} Antipicture`;
                else if (/6/.test(number)) cmd = `${prefix + selector} Antivideo`;
                else if (/3/.test(number)) cmd = `${prefix + selector} Antisticker`;
                else if (/4/.test(number)) cmd = `${prefix + selector} Antispam`;
                else if (/5/.test(number)) cmd = `${prefix + selector} gcchatbot`;
                else if (/6/.test(number)) cmd = `${prefix + selector} NSFW`;
                else cmd = `_404`;
              }
              break;
