...
const number = Number(num[0]);
    ...
    switch (id) {
        ...
        function getVid() {
            ...
            if (/1/.test(number)) {
                cmd = `${prefix}songaudiocommand https://www.youtube.com/watch?v=${getVid()}`;
            } else if (/2/.test(number)) {
                cmd = `${prefix}songdocumentcommand https://www.youtube.com/watch?v=${getVid()}`;
            } else cmd = `_404`;
        }
        break;
