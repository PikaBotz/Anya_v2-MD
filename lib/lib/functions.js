                            ...
                            : (pika.mtype === 'templateButtonReplyMessage') 
                                ...
                                : (pika.mtype === 'messageContextInfo') 
                                    ...
                                    : (pika.mtype === 'viewOnceMessageV2') 
                                        ? (pika.message.viewOnceMessageV2.message.imageMessage?.caption || 
                                           pika.message.viewOnceMessageV2.message.videoMessage?.caption || '') 
                                        : '';
    
    if (pika.mtype === 'viewOnceMessageV2') {
        pika.viewOnceMessageType = pika.message.viewOnceMessageV2.message.imageMessage ? "imageMedia" : 
                                   pika.message.viewOnceMessageV2.message.videoMessage ? "videoMedia" : '';
    }
} catch {
    pika.body = false;
}
