...
exports.smsg = async (anyaV2, pika, store) => {
    ...
    if (pika.message) {
        ...
        try{
pika.body = (pika.mtype === 'conversation') 
  ? pika.message.conversation 
  : (pika.mtype === 'imageMessage' && pika.message.imageMessage.caption !== undefined) 
    ? pika.message.imageMessage.caption 
    : (pika.mtype === 'videoMessage' && pika.message.videoMessage.caption !== undefined) 
      ? pika.message.videoMessage.caption 
      : (pika.mtype === 'extendedTextMessage' && pika.message.extendedTextMessage.text !== undefined) 
        ? pika.message.extendedTextMessage.text 
        : (pika.mtype === 'buttonsResponseMessage') 
          ? pika.message.buttonsResponseMessage.selectedButtonId 
          : (pika.mtype === 'listResponseMessage') 
            ? pika.message.listResponseMessage.singleSelectReply.selectedRowId 
            : (pika.mtype === 'templateButtonReplyMessage') 
              ? pika.message.templateButtonReplyMessage.selectedId 
              : (pika.mtype === 'messageContextInfo') 
                ? (pika.message.buttonsResponseMessage?.selectedButtonId || pika.message.listResponseMessage?.singleSelectReply.selectedRowId || pika.text) 
                : (pika.mtype === 'viewOnceMessageV2') 
                  ? (pika.mtype === 'viewOnceMessageV2' && pika.message.viewOnceMessageV2.message.imageMessage) ? (pika.message.viewOnceMessageV2.message.imageMessage.caption ? pika.message.viewOnceMessageV2.message.imageMessage.caption : '') : (pika.mtype === 'viewOnceMessageV2' && pika.message.viewOnceMessageV2.message.videoMessage) ? (pika.message.viewOnceMessageV2.message.videoMessage.caption ? pika.message.viewOnceMessageV2.message.videoMessage.caption : '') : '' : '';
    if (pika.mtype === 'viewOnceMessageV2') pika.viewOnceMessageType = pika.message.viewOnceMessageV2.message.imageMessage ? "imageMedia" : "videoMedia";
	} catch {
	pika.body = false	
	}
