...
class database {
    ...
    static async set(field, value) {
        ...
        switch (field) {
            case 'react':
                update = { $set: { react: value } };
                break;
            case 'anticall':
                update = { $set: { anticall: value } };
                break;
            case 'chatbot':
                update = { $set: { chatbot: value } };
                break;
            case 'welcome':
                update = { $set: { welcome: value } };
                break;
            case 'goodbye':
                update = { $set: { goodbye: value } };
                break;
            case 'promote':
                update = { $set: { promote: value } };
                break;
            case 'demote':
                update = { $set: { demote: value } };
                break;
            case 'events':
                update = { $set: { events: value } };
                break;
            case 'prefix':
                update = { $set: { prefix: value } };
                break;
            case 'worktype':
                update = { $set: { worktype: value } };
                break;
            case 'enabled':
                update = { $set: { enabled: value } };
                break;
            case 'autoTyping':
                update = { $set: { autoTyping: value } };
                break;
            case 'autoMsgRead':
                update = { $set: { autoMsgRead: value } };
                break;
            case 'alwaysOnline':
                update = { $set: { alwaysOnline: value } };
                break;
            case 'autoStatusRead': 
                update = { $set: { autoStatusRead: value } };
                break;
            case 'autoReactMsg':
                update = { $set: { autoReactMsg: value } };
                break;
            case 'autoReply':
                update = { $set: { autoReply: value } };
                break;
            case 'autoVoice':
                update = { $set: { autoVoice: value } };
                break;
            case 'autoBlockPM':
                update = { $set: { autoBlockPM: value } };
                break;
            case 'antiDeleteMsg':
                update = { $set: { antiDeleteMsg: value } };
                break;
            default:
