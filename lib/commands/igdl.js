...
async function getCommand(react, text, AnyaPika){
require('../../config');
  const axios = require('axios');
  if (!text) return m.reply('I needed a insta video link.');
  if (!text.includes("instagram.com/")) return m.reply("Please enter a valid insta video url!");
  try {
