...
anya({
    ...
    async (anyaV2, pika, { prefix }) => {
        ...
        const caption = `\`\`\`
${Config.themeemoji} Wabot Status ${Config.themeemoji}
\`\`\`
...
> *Cᴏɴᴛᴀᴄᴛ :* https://wa.me/${Config.ownernumber}?text=Hello
> *Group :* https://chat.whatsapp.com/E490r0wSpSr89XkCWeGtnX`;
...
> _Type \`.help\` for more help on how to use a command._
${readmore}\n`;
    ...
    caption += `🎀 _Type ${prefix}listmenu for command list._
...
✦ 𝚅𝚎𝚛𝚜𝚒𝚘𝚗 : ${require('../../package.json').version}
✦ 𝙾𝚠𝚗𝚎𝚛 : ${Config.ownername}
✦ Categories : ${Object.keys(patterns).length}
✦ 𝙼𝚎𝚖 : ${getMemoryInfo().usedMemory}/${getMemoryInfo().totalMemory}
