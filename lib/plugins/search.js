...
anya(
	...
	async (anyaV2, pika, { args, prefix }) => {
		...
		if (text.includes("https://www.wattpad.com/story/")) return pika.reply("_Use `" + prefix + "wattread <url>` for URLs");
...
_click on the button below to download story!_
`.trim(); console.log(list);
			await anyaV2.sendButtonImage(pika.chat, {
				caption,
				image: { url: "https://i.ibb.co/wpL7DqN/bec82ba3-610e-4c04-8d14-b871f1c41e9d.jpg" },
			...
			return await anyaV2.sendMessage(pika.chat, {
				...
				contextInfo: {
					externalAdReply: {
						...
						thumbnailUrl: "https://i.ibb.co/wpL7DqN/bec82ba3-610e-4c04-8d14-b871f1c41e9d.jpg",
						mediaType: 1,
...
anya(
	...
	async (anyaV2, pika, { args }) => {
	    ...
	    if ((response.results.length < 1) || !response.status) return pika.reply("_❌ No Result Found!_");
	    let caption = `
*🧩 𝐒𝐭𝐞𝐚𝐦 𝐒𝐞𝐚𝐫𝐜𝐡 𝐄𝐧𝐠𝐢𝐧𝐞 🧩*
