...
anya(
  ...
  async (anyaV2, pika, { args, prefix, command }) => {
    ...
    if (/--ai\b/.test(input.toLowerCase()) {
      ...
      chatGpt4(pika.sender.split("@")[0], `Please translate the following and understand the intention in ${promptLang} language: ` + cleanedUp)
      .then(response => {
