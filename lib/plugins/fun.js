...
`.trim();
                if (ui.buttons) {
                    ...
                    return pika.reply(caption + `> type _${prefix + command} --random_ for random tag`, { mentions: [member] });
                }
...
`.trim();
                if (ui.buttons) {
                    ...
                    return pika.reply(caption + `> type _${prefix + command} --random_ for random tag`, { mentions: [user] });
                }
            } else {
