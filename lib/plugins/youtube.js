        ...
        if (ui.buttons) {
            ...
            return await anyaV2.sendButtonImage(pika.chat, {
                ...
                buttons: [
                    {
                        "name": "single_select",
                        "buttonParamsJson": `{\"title\":\"Choose Video 🍁\",\"sections\":[{\"title\":\"✨ 𝗖𝗵𝗼𝗼𝘀𝗲 𝘆𝗼𝘂𝗿 𝗳𝗮𝘃. 𝘃𝗶𝗱𝗲𝗼 ✨\",\"highlight_label\":\"Anya YT Engine\",\"rows\":[${buttonsArray.join(",")}]}]}`
                    },
                    {
                        "name": "cta_url",
...
*🍁 Channel:* ${info.author.user}
            ...
            caption += `*1 ${symbols} 360p*\n`;
            caption += `*2 ${symbols} 360p* _(📄document)_\n`;
...
`;
            if (ui.buttons) {
                return await anyaV2.sendButtonVideo(pika.chat, {
                    video: await getBuffer(info.videoUrl),
            ...
            const buttonsArray = [
                `{\"header\":\"${Config.themeemoji} 360p\",\"title\":\"𝘵𝘢𝘱 𝘩𝘦𝘳𝘦 𝘵𝘰 𝘥𝘰𝘸𝘯𝘭𝘰𝘢𝘥\",\"description\":\"\",\"id\":\"${prefix}ytv2 ${info.url} 360p\"}`,
                `{\"header\":\"${Config.themeemoji} 360p (document)\",\"title\":\"𝘵𝘢𝘱 𝘩𝘦𝘳𝘦 𝘵𝘰 𝘥𝘰𝘸𝘯𝘭𝘰𝘢𝘥\",\"description\":\"\",\"id\":\"${prefix}ytvdoc ${info.url} 360p\"}`,
                `{\"header\":\"${Config.themeemoji} audio\",\"title\":\"𝘵𝘢𝘱 𝘩𝘦𝘳𝘦 𝘵𝘰 𝘥𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘵𝘩𝘪𝘴 𝘢𝘶𝘥𝘪𝘰\",\"description\":\"\",\"id\":\"${prefix}yta2 ${info.url}\"}`,
                `{\"header\":\"${Config.themeemoji} audio (document)\",\"title\":\"𝘵𝘢𝘱 𝘩𝘦𝘳𝘦 𝘵𝘰 𝘥𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘵𝘩𝘪𝘴 𝘢𝘶𝘥𝘪𝘰\",\"description\":\"\",\"id\":\"${prefix}ytadoc ${info.url}\"}`
            ];
