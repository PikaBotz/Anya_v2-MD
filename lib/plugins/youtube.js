...
`;
            if (ui.buttons) {
                await anyaV2.sendButtonVideo(pika.chat, {
                ...
                pika.edit("> ✅ " + args[1] + " video proceeded!");
                fs.unlinkSync(path);
            } else {
                ...
                return pika.edit("> ✅ " + args[1] + " video proceeded!");
            }
          ...
          */
            ...
            if (!info.qualities["video" + args[1]]) return pika.reply("_‼️ Quality Not Found!_");
            const { key } = await pika.keyMsg(Config.message.wait);
             console.log(info.qualities["video" + args[1]])
...
`;
            if (ui.buttons) {
                ...
                return pika.edit("> ✅ 360p video proceeded!");
            } else {
                await anyaV2.sendMessage(pika.chat, {
                    video: buffer,
                    caption: caption
